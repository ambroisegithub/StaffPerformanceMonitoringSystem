...
import { loginUser, clearErrors } from "../Redux/Slices/LoginSlices";
...
const Login: React.FC = () => {
  ...
  const { loading, error, isFirstLogin } = useSelector((state: RootState) => state.login)
        ...
        <div className="grid lg:grid-cols-2 gap-12 p-8 lg:p-12 items-center">
          <div className="flex flex-col justify-center">
            ...
            <p className="text-gray-700 mb-8">
              Log in to access your dashboard and manage your workforce
              efficiently.
            </p>
            <Formik
