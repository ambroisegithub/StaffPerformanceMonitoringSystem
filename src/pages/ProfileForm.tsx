...
import { Loader2, Camera, User, X, ZoomIn } from "lucide-react"
      ...
      <Card className="w-full max-w-5xl mx-auto border-0 shadow-xl bg-white/90 backdrop-blur-sm rounded-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="p-6 space-y-6">
            ...
            <div className="flex flex-col items-center sm:flex-row sm:items-start gap-6 bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-6 border border-slate-200">
          ...
          <CardFooter className="bg-gradient-to-r from-white via-slate-50 to-white px-6 py-4 border-t border-slate-200 flex justify-end gap-3">
            {isEditing ? (
              <>
                <Button 
                  type="button" 
                ...
                <Button 
                  type="submit" 
                  disabled={updateLoading} 
                  className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white h-10 px-8 rounded-lg font-semibold text-sm shadow-lg transition-all duration-200"
                >
                  {updateLoading ? (
                    <>
              ...
              <Button 
                ...
                className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white h-10 px-8 rounded-lg font-semibold text-sm shadow-lg transition-all duration-200"
              >
                Edit Profile
              </Button>
            )}
