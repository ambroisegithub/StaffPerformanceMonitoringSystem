...
import { resetPassword, clearState } from "../Redux/Slices/confirmPasswordResetSlice"
...
const ConfirmToChangePassword: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green via-white to-purple-50 flex items-center justify-center p-4">
