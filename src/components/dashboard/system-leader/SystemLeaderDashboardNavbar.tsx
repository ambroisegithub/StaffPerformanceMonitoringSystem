...
import { useTheme } from '../Client/ThemeContext';
...
interface SystemLeaderDashboardNavbarProps {
  toggleSidebar: () => void;
}

const SystemLeaderDashboardNavbar = ({ toggleSidebar }: SystemLeaderDashboardNavbarProps) => {
  ...
  return (
    <nav className="px-4 py-3 flex items-center justify-between shadow-sm bg-white dark:bg-gray-800">
      <div className="flex items-center">
        ...
        <h1 className="ml-4 text-xl font-semibold text-gray-800 dark:text-white">Account Manager</h1>
      </div>
...
export default SystemLeaderDashboardNavbar;