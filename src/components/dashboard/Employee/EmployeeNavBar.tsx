    ...
    <nav className="px-4 py-3 flex items-center justify-between shadow-sm bg-white dark:bg-gray-800">
      ...
      <div className="hidden sm:flex flex-1 justify-center">
        <div className="text-center">
          <h1 className="text-xl font-bold bg-gradient-to-r from-slate-700 via-blue-800 to-slate-700 bg-clip-text text-transparent dark:from-slate-300 dark:via-blue-300 dark:to-slate-300 tracking-wide">
