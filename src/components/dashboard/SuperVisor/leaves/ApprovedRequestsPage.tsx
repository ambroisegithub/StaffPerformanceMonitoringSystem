                              ...
                              <TableCell className="px-4 py-3 text-right whitespace-nowrap">
                                <div className="flex justify-end gap-2">
                                  {leave.review_count === 5 ? (
                                    ...
                                    <span className="inline-block px-3 py-2 text-xs font-semibold text-yellow-700 bg-yellow-100 rounded shadow-sm cursor-not-allowed select-none">
                                      Wait for final approve
                                    </span>
                                  )}
                                </div>
                              </TableCell>
