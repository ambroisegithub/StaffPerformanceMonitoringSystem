...
const CreateTask: React.FC = () => {
  ...
  useEffect(() => {
    // Determine required fields based on whether company exists
        ...
        <Card className="shadow-sm">
          <CardHeader className="bg-gray-50 border-b py-3">
            <CardTitle className="text-lg font-medium flex items-center">
              <FaClipboardList className="mr-2 text-blue" /> Create New Task
            </CardTitle>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="md:col-span-2">
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-0.5">{taskData.achieved_deliverables.length}/300 characters</p>
                </div>
              </div>
